...
class _MonthYearPickerDialogState extends State<MonthYearPickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final MonthYearPickerLocalizations localizations = MonthYearPickerLocalizations.of(context);
    ...
    // layout issues.
    final TextScaler textScaler = media.textScaler;
    final TextDirection direction = Directionality.of(context);

    final String dateText = materialLocalizations.formatMonthYear(_selectedDate);
    ...
    final String semanticText = materialLocalizations.formatMonthYear(_selectedDate);
    ...
    final picker = LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double? width = constraints.maxHeight < pickerMaxWidth
