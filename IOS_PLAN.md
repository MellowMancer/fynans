...
| M5.4 | Open a pull request from `ios_build` to `main`, review and merge ([§9](#9-risks--mitigations), R4) | PR approved; CI or local checks green; merged | 2 h | In progress (2026-09-25) — opening now, ahead of M5.1–M5.3 by Rahul's choice |
